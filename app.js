...
function homFunction() {
        ...
        if(bayHom == true){
                ...
                mon.innerHTML ='Денег: ' + monschet;
                bayHom = true;
                var ceHom = document.getElementById('cenaHom');
                ceHom.innerHTML =' ';
                autoo = setInterval("autooClickAll()", 1000);
...
function catFunction() {       
        ...
        else if(monschet>=150){
                monschet = monschet - 150;
                mon.innerHTML ='Денег: ' + monschet;
                bayCat = true;
                var ceCat = document.getElementById('cenaCat');
                ceCat.innerHTML =' ';
                autoo = setInterval("autooClickAll()", 500);
...
function dogFunction() {       
        ...
        else if(monschet>=250){
                monschet = monschet - 250;
                mon.innerHTML ='Денег: ' + monschet;
                bayDog = true;
                var ceDog = document.getElementById('cenaDog');
                ceDog.innerHTML =' ';
                autoo = setInterval("autooClickAll()", 250);
